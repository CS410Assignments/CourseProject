...
- <b>Usage</b>: To run ranker.py type 'python ranker.py -n 10 -q "subreddit ranker"' Edit 10 and "subreddit ranker" to be the number of results and the query, respectively.
